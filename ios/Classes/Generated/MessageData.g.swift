...
class RequesterToFlutter {
  ...
  func audioSessionDidDrop(completion: @escaping (Result<Void, FlutterError>) -> Void) {
  ...
  func videoTileAdded(info infoArg: TileInfo, completion: @escaping (Result<Void, FlutterError>) -> Void) {
